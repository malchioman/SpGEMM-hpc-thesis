...
- Rank 0 gathers the final distributed CSR result and validates it against a serial SpGEMM implementation. Non-finite results are rejected, and the validation exit status is broadcast to all ranks before finalization.
